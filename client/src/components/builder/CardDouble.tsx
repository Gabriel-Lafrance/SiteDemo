...
import { fadeInLeft, fadeInRight, popin } from "../../framermotion/Animation";
...
const CardDouble = (props : CardDoubleProps) => {
    ...
    return (
        ...
        {
            props.inverse ? 
            <AnimatedDiv  parentRef={props.ref} variant={popin}  className="grid grid-cols-1 w-auto sm:grid-cols-2 h-fit mx-auto m-8 hover:scale-105 transition-all duration-200 drop-shadow-2xl">
            ...
            :
            <AnimatedDiv parentRef={props.ref} variant={popin}   className="grid grid-cols-1 sm:grid-cols-2 w-auto h-fit mx-auto m-8 hover:scale-105 transition-all duration-200 drop-shadow-2xl">
